...
class HomeActivity : BaseActivity() {
    ...
    private fun initBottomNavigation() {
        ...
        homeBinding.btnFoodPrice.setOnClickListener {
            replaceFragment(FoodPriceFragment())
    ...
    private fun updateBottomMenuUI(index: Int) {
        ...
        homeBinding.textFoodPrice.setTextColor(if (index == 2) activeColor else defaultColor)
        ...
        homeBinding.textMySellInfo.setTypeface(null, if(index==1)
            android.graphics.Typeface.BOLD else android.graphics.Typeface.NORMAL)
        homeBinding.textFoodPrice.setTypeface(null, if(index==2)
            android.graphics.Typeface.BOLD else android.graphics.Typeface.NORMAL)
